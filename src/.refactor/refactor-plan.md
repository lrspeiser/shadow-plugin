# Refactoring Plan (Offline Analysis)
...
1. Review the **EXACT DUPLICATES** section above
2. For each duplicate group, decide which location to keep
3. Update imports in files that used the deleted copies
4. Review **DEAD CODE** section and delete unused exports
5. Run tests to verify nothing broke

*For deeper analysis of similar-but-not-identical code, run with --llm flag*
